package utilisateur;
//cette classe concerne les prÈfÈrences de l'utilisateur donc va dans package utilisateur
import java.util.ArrayList;


import system.AbsMedia;
import system.AbsVideo;
import system.GenreCalc;
...
public class MediaSelection {
    ...
    public void MajorityofVideo(){ // le but de cette fonction est de tri√© les pr√©f√©rences d'un utilisateur
	String typeac;
